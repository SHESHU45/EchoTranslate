...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl text-blue-400'>Echo<span className='text-yellow-400 bold'>Translate</span></h1>
            <h3 className='font-medium md:text-lg'> Hit Record & Pray We Heard You Right <span className='text-blue-400'>&rarr;</span> Transcribe: Turning Your Mumbles into Words <span className='text-blue-400'>&rarr;</span> Translate: Because Google Translate Needs a Break </h3>
            ...
            <p className='italic text-slate-400'>Free forever! (Forever = until we decide it’s not.)</p>
        </main>
    )
}
